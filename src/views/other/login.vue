	...
	<div class="login_page">
		<el-form class="login_form" ref="form" :model="form" :rules="rules">
			...
			<el-form-item class="login_input" prop="name">
				...
				<el-input placeholder="请输入用户名" v-model.trim="form.name" maxlength="30" @keyup.enter.native="handleLogin"></el-input>
			</el-form-item>
			<el-form-item class="login_input remeber_forget" prop="passwd">
				<span class="iconfont iconsuo"></span>
				<el-input placeholder="请输入密码" :type="isShowPwd ? 'text' : 'password'" v-model.trim="form.passwd" maxlength="30" @keyup.enter.native="handleLogin"></el-input>
				<span class="control_pwd iconfont" :class="isShowPwd ? 'iconyanjing' : 'iconbiyan'" @click="handleShowPwd"></span>
			</el-form-item>
				...
				this.$message({
					...
					onClose: () => {
						if (res.code === 0) {
							...
							setNameKey(this.form.name)
							this.SET_USERNAME(this.form.name)
